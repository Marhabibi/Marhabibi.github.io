	...
	<style type="text/css">
		...
		* {
		...
		.bg_img{
			...
			/*filter: sepia() saturate(1000%) hue-rotate(8deg);*/
...
<!-- <i  style= "font-size: 20px;" class="fa fa-tasks"></i> -->
  		...
  		<!-- <a class="box" href="#" onclick="myFunction('projects')"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="fa fa-cogs"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg> <span style = "font-weight: bold;">Project</span></a> -->
  		...
  		<!-- <a class="box " href="#" onclick="myFunction('codes')"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-code"><polyline points="16 18 22 12 16 6"></polyline><polyline points="8 6 2 12 8 18"></polyline></svg> <span style = "font-weight: bold;">Code</span></a> -->
...
<br>
	...
	<section id = "projects" style="clear:both;display:none;">
		...
		<br>
					...
					<!-- <div style="font-weight: bold;font-size: 16px;"><span style= "float:right;">2011-2014</span></div> -->
